...
export default function WorkPage() {
  const projects = [
    ...
    {
      id: "formy-magic-create",
      title: "FORMY MAGIC CREATE",
      subtitle: "Form Builder Application",
      description:
        "Dynamic form builder application that allows users to create and manage custom forms. Features drag-and-drop interface, form validation, and submission handling built with TypeScript.",
      tech: ["TypeScript", "React", "Form Builder", "Validation"],
      year: "2025",
      status: "LIVE",
      category: "FULL-STACK DEVELOPMENT",
      githubUrl: "https://github.com/dariyozz/formy-magic-create",
    },
    {
      id: "shifty",
      title: "SHIFTY",
      subtitle: "Shift Scheduling Application",
      description:
        "Shift scheduling and management application for organizing work shifts. Features calendar integration, notification system, and user-friendly interface for managing team schedules.",
      tech: ["TypeScript", "React", "Scheduling", "Calendar"],
      year: "2025",
      status: "LIVE",
      category: "FULL-STACK DEVELOPMENT",
      githubUrl: "https://github.com/dariyozz/Shifty",
    },
    {
      id: "github-actions",
      ...
      description:
        "GitHub Actions workflows and CI/CD pipeline implementations. Features automated testing, deployment workflows, and GitHub automation best practices.",
      tech: ["GitHub Actions", "CI/CD", "YAML", "Automation", "HTML"],
      year: "2025",
      status: "LIVE",
      category: "DEVOPS & CLOUD",
      githubUrl: "https://github.com/dariyozz/Github-Actions---Part1",
    },
    {
      id: "jenkins-blueocean",
      title: "JENKINS BLUEOCEAN",
      subtitle: "CI/CD Pipeline Visualization",
      description:
        "Jenkins Blue Ocean pipelines for modern CI/CD visualization. Features pipeline as code, multi-branch pipelines, and Jenkins automation for continuous integration and deployment.",
      tech: ["Jenkins", "Blue Ocean", "CI/CD", "Groovy", "HTML"],
      year: "2025",
      status: "LIVE",
      category: "DEVOPS & CLOUD",
      githubUrl: "https://github.com/dariyozz/jenkins-blueocean",
    },
    {
      id: "ai-labs",
      title: "AI LABS 2025",
